<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <main class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            ...
            :key="opportunity.id" 
            class="opportunity-card group relative overflow-hidden bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 hover:border-gray-200 flex flex-col h-full"
          >
            ...
            <div class="relative pt-[56.25%] bg-gray-50 overflow-hidden">
              ...
              />
              <div v-else class="absolute inset-0 flex items-center justify-center text-gray-400 bg-gray-50">
    ...
    <AdminModal
      ...
      @opportunities-updated="handleOpportunitiesUpdated"
    />
  </div>
</template>
...
import AdminModal from './components/AdminModal.vue'; // eslint-disable-line no-unused-vars
...
export default {
  ...
  setup() {
    ...
    const handleOpportunitiesUpdated = () => {
      // Reload opportunities data after update
      // In a real implementation, you might want to refetch from GitHub

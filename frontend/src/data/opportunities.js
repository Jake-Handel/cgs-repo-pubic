...
export default [
    ...
    },
    {
      ...
      datenum: 1,
      location: "ANU & University of Queensland",
      application: "Student Registration",
    ...
    datenum: 8,
    location: "Online, finals in University of Pennsylvania",
    application: "Online Registration",
    ...
    {
      id: 33,
      title: "Australian Individual Debating and Public Speaking Championships (AIDPSC)",
      image: "aidpsc.png",
      type: "Competition (In-person)",
      ...
      datenum: 9,
      date: "September",
      location: "National, then International Rounds",
      application: "Teacher Registration",
      applicationLink: "https://aidpsc.com/#event-guidelines-and-descriptions",
      categories: [CATEGORIES[2]]
    },
    {
      id: 34,
      ...
      image: "hmun.png",
      type: "Competition (In-person)",
      audience: "High School (13+)",
      cost: "$290-500",
      datenum: 5,
      date: "May",
      location: "State, then International Rounds",
      application: "Online Application",
      applicationLink: "https://www.hmunaustralia.org/application-process",
      categories: [CATEGORIES[2]]
    },
    {
      id: 35,
      title: "National Mathematics Summer School (NMSS)",
      image: "nmss.png",
      type: "Summer School (In-person)",
      audience: "Year 11-12",
      cost: "Varies",
      datenum: 5,
      date: "January (Applications in May)",
      location: "Canberra",
      application: "Online Registration",
      applicationLink: "https://nmss.edu.au/",
      categories: [CATEGORIES[3], CATEGORIES[8]]
    },
    {
      id: 36,
      title: "International Mathematical Modelling Challenge (IMMC)",
      image: "immc.png",
      type: "Competition (Hybrid)",
      audience: "High School",
      cost: "$75 per team",
      ...
      application: "Online Registration",
      applicationLink: "https://www.immchallenge.org.au/",
      categories: [CATEGORIES[3], CATEGORIES[7]]
    },
    {
      id: 37,
      title: "Young Women In Engineering (YoWIE)",
      image: "yowie.png",
      type: "Conference (In-person)",
      audience: "Year 9-12",
      cost: "Free",
    ...
    {
      id: 38,
      title: "Girls' Programming Network",
      image: "girls-programming.png",
      type: "Club (In-person)",
      audience: "High School",
      cost: "Varies",
      datenum: 13,
      date: "Across the Year",
      location: "Australia",
      application: "Online Registration",
    ...
    },
    {
      id: 39,
      title: "Curious Minds",
      image: "curious-minds.png",
      type: "Internship/Mentoring (In-person)",
      audience: "Year 8-10",
      cost: "Varies",
      datenum: 13,
      date: "Across the Year",
      location: "Australia",
      application: "Online Registration",
      applicationLink: "https://curiousminds.edu.au/curious-minds-students/",
      categories: [CATEGORIES[3], CATEGORIES[8]]
    },
    {
      id: 40,
      title: "Da Vinci Decathlon",
      image: "da-vinci.png",
      type: "Competition (In-person)",
      audience: "Year 7-10",
      cost: "Varies",
      ...
      location: "State, then National Rounds",
      application: "School Registration",
      applicationLink: "https://www.davincidecathlon.com/",
      categories: [CATEGORIES[7]]
    },
    {
      id: 41,
